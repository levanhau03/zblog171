...
return array(
    ...
    'lang'                  => 'vi',
    'lang_bcp47'            => 'vi', // https://www.w3schools.com/tags/ref_language_codes.asp
    ...
    'msg' => array(
        ...
        'number_page'                       => 'Trang %num%',
        'parent_category'                   => 'Parent',
        'password'                          => 'Mật khẩu',
        're_password'                       => 'Nhập lại mật khẩu',
        'upload_file'                       => 'Chọn tệp để tải lên',
        'auto_rename_uploadfile'            => 'Tự động đổi tên tệp',
        'username'                          => 'Tài khoản',
        'return_to_site'                    => 'Trang web',
        'check_comment'                     => 'Duyệt bình luận',
        'dashboard'                         => 'Trang quản lý',
        'settings'                          => 'Cài đặt',
        'web_settings'                      => 'Cài đặt trang web',
        'official_website'                  => 'Trang chính thức',
        'parend_id'                         => 'PID',
        'select_all'                        => 'Chọn tất cả',
        'new_article'                       => 'Đăng bài',
        'new_page'                          => 'Thêm trang mới',
        'new_tag'                           => 'Thêm nhãn mới',
        'new_member'                        => 'Thêm người dùng mới',
        'new_category'                      => 'Thêm danh mục mới',
        'new_module'                        => 'Thêm mô-đun mới',
        'article_edit'                      => 'Sửa bài viết',
        'page_edit'                         => 'Sửa trang',
        'article_manage'                    => 'Bài viết',
        'page_manage'                       => 'Trang',
        'category_manage'                   => 'Danh mục',
        'category_edit'                     => 'Sửa danh mục',
        'tag_manage'                        => 'Nhãn',
        'tag_edit'                          => 'Sửa nhãn',
        'member_edit'                       => 'Sửa người dùng',
        'module_edit'                       => 'Sửa mô-đun',
        'module_navbar'                     => 'Thanh điều hướng',
        'module_misc'                       => 'Biểu tượng',
        'module_link'                       => 'Liên kết',
        'module_favorite'                   => 'Bộ sưu tập',
        'comment_manage'                    => 'Bình luận',
        'upload_manage'                     => 'Đính kèm',
        'member_manage'                     => 'Người dùng',
        'theme_manage'                      => 'Giao diện',
        'plugin_manage'                     => 'Plugins',
        'module_manage'                     => 'Modules',
        'site_analyze'                      => 'Thông tin trang web',
        'info_intro'                        => 'Trang quản lý',
        'refresh_cache'                     => 'Làm mới bộ nhớ &amp; giao diện',
        'latest_news'                       => 'Tin tức về Z-Blog',
        'refresh'                           => 'Làm mới',
        'post_count'                        => 'Bài viết',
        'basic_setting'                     => 'Cài đặt chung',
        'global_setting'                    => 'Cài đặt toàn cầu',
        'page_setting'                      => 'Cài đặt trang',
        'comment_setting'                   => 'Cài đặt bình luận',
        'api_setting'                       => 'Cài đặt API',
        'other_setting'                     => 'Các cài đặt khác',
        'blog_host'                         => 'Địa chỉ trang web',
        'blog_host_add'                     => 'URL hiện tại được tự động đọc theo mặc định, nếu bạn cần sửa tên miền của trang web, vui lòng nhấp vào nút và nhập tên miền.',
        'copyright'                         => 'Thông báo bản quyền',
        'copyright_add'                     => 'Bạn có thể điền vào mã thống kê, số giấy phép',
        'blog_name'                         => 'Tiêu đề trang web',
        'blog_subname'                      => 'Phụ đề của trang web',
        'permanent_domain'                  => 'Tên miền trang web cố định',
        'blog_timezone'                     => 'Múi giờ trang web',
        'blog_language'                     => 'Ngôn ngữ trang web',
        'allow_upload_type'                 => 'Loại tệp được phép tải lên',
        'allow_upload_size'                 => 'Kích thước tệp tải lên (tính bằng MB)',
        'debug_mode'                        => 'Chế độ phát triển',
        'display_count'                     => 'Hiển thị trang danh sách số lượng bài viết',
        'pagebar_count'                     => 'Hiển thị số lượng trang được lật',
        'search_count'                      => 'Cho phép tìm kiếm để trả về số lượng bài viết tối đa',
        'manage_count'                      => 'Số lượng bài viết được hiển thị trên mỗi trang trong nền',
        'comment_turnoff'                   => 'Tắt bình luận',
        'comment_reverse_order'             => 'Bật đảo ngược bình luận',
        'comments_display_count'            => 'Số lượng nhận xét trên mỗi trang',
        'comment_verify_enable'             => 'Mã xác minh bình luận',
        'stay_signed_in'                    => 'Ghi nhớ đăng nhập',
        'notify'                            => 'Thông báo',
        'current_member'                    => 'Người dùng hiện tại',
        'current_version'                   => 'Phiên bản hiện tại',
        'all_artiles'                       => 'Tổng số bài viết',
        'all_pages'                         => 'Tổng số trang',
        'all_tags'                          => 'Tổng số nhãn',
        'all_categorys'                     => 'Tổng số danh mục',
        'all_comments'                      => 'Tổng số bình luận',
        'all_members'                       => 'Tổng số người dùng',
        'all_views'                         => 'Tổng lượt xem',
        'all_uploads'                       => 'Tổng số tệp đính kèm',
        'current_theme'                     => 'Giao diện hiện tại',
        'current_style'                     => 'Phong cách hiện tại',
        'default_avatar'                    => 'Hình đại diện mặc định',
        'style'                             => 'Phong cách',
        'theme'                             => 'Giao diện',
        'system_module'                     => 'Mô-đun hệ thống',
        'user_module'                       => 'Mô-đun người dùng',
        ...
        'sidebar8'                          => 'Sidebar 8',
        'sidebar9'                          => 'Sidebar 9',
        'display_subcategorys'              => 'Liệt kê các bài viết trong thư mục con',
        'drag_module_to_sidebar'            => 'Để kích hoạt một mô-đun, hãy kéo mô-đun đó vào một thanh bên. Để hủy kích hoạt một mô-đun, hãy kéo mô-đun đó trở lại.',
        'sidebar_module_count'              => 'Mô-đun %s tích hợp sẵn',
        'protocol_address'                  => 'Địa chỉ giao thức',
        'xmlrpc_address'                    => 'XML-RPC',
        'api_address'                       => 'API Url',
        'system_environment'                => 'Môi trường hệ thống',
        'view_rights'                       => 'Xem quyền',
        'member_level'                      => 'Cấp độ người dùng',
        'disable_comment'                   => 'Tắt bình luận',
        'default_template'                  => 'Giao diện mặc định',
        'generate_summary'                  => 'Tự động tạo tóm tắt',
        'add_to_navbar'                     => 'Add to Navigation Bar',
        'help_generate_summary'             => 'Chèn dấu phân tách đầu tiên trong văn bản và nội dung phía trên dấu phân cách sẽ được sử dụng làm phần tóm tắt.',
        'use_commas_to_separate'            => 'Phân tách bằng dấu phẩy',
        'show_common_tags'                  => 'Hiển thị nhãn hay sử dụng',
        'category_aritles_default_template' => 'Mẫu mặc định cho các bài viết trong danh mục này',
        ...
        'comment_audit'                     => 'Kiểm tra bình luận',
        'comment_audit_comment'             => 'Tất cả các bình luận mới được đăng bởi người dùng sẽ được kiểm tra.',
        'debugging_warning'                 => 'Z-BlogPHP của bạn đã mở chế độ gỡ lỗi. Ở chế độ này, trang web có nguy cơ bị hack, nếu thực sự trang web được triển khai trực tuyến, vui lòng đóng chế độ gỡ lỗi kịp thời!',
        'permanent_domain_with_admin'       => 'Tên miền cố định cũng được sử dụng trong phần phụ trợ',
        'current_template'                  => 'Giao diện hiện tại',
        'additional_security'               => 'Tăng cường bảo mật',
        'using_cdn_guest_type'              => 'Nguồn IP của khách',
        'first_button'                      => '‹‹',
        'prev_button'                       => '‹',
        'next_button'                       => '›',
        'last_button'                       => '››',
        'numeral_button'                    => '%num%',
        'verify_succeed'                    => 'Xác minh thành công',
        'verify_fail'                       => 'Xác minh thất bại',
        'verifying'                         => 'Kiểm tra',
        'show_warning_error'                => 'Hiện cảnh báo lỗi',
        'backend_setting'                   => 'Cài đặt nền',
        'get_text_intro'                    => 'Nhận phần giới thiệu văn bản thuần túy',
        ...
        'enable_xmlrpc'                     => 'Bật giao thức XML-RPC',
