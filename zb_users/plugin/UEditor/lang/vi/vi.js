...
UE.I18N['vi'] = {
    ...
    'charts':{
        'static':{
            ...
            'lang_cahrt_tip_description': 'Chỉ biểu đồ hình tròn là hợp lệ. Khi chuột được di chuyển đến khối tương ứng trong biểu đồ hình tròn, tiền tố của văn bản trong hộp nhắc',
            'lang_chart_data_unit': 'Unit',
            'lang_chart_data_unit_title': 'unit:',
            'lang_chart_data_unit_description': 'Đơn vị của dữ liệu được hiển thị trên mỗi điểm dữ liệu, ví dụ: đơn vị nhiệt độ ℃',
